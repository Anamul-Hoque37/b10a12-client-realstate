        ...
        <div className='container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12'>
          <div className='wf-ull lg:w-1/2'>
            ...
            <div className='flex items-center mt-6 gap-x-3'>
              ...
              <Link
                to='/'
                className='w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-fuchsia-700 hover:bg-fuchsia-900 rounded-lg shrink-0 sm:w-auto'
              >
                Take me home
              </Link>
            </div>
          ...
          <div className='relative w-full mt-8 lg:w-1/2 lg:mt-0'>
            <img
              ...
              src='https://i.ibb.co.com/5xRsbMf/404-1.png'
              alt=''
            />
          </div>
        </div>

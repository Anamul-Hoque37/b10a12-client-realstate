            ...
            <div className="navbar flex justify-between bg-gradient-to-l from-slate-700 via-fuchsia-700 to-slate-700 text-white">
                <div className="flex">
                    <div className="dropdown">
                        ...
                        <ul
                            tabIndex={0}
                            className="menu menu-sm dropdown-content bg-fuchsia-700 rounded-box z-10 mt-3 w-48 p-2 shadow">
                            {
                                Links
                            }
                        </ul>
                ...
                <div className="flex gap-1">
                    ...
                    <div className='flex'>
                        ...
                        <div className="dropdown dropdown-end">
                            ...
                            <ul
                                tabIndex={0}
                                className="menu menu-sm dropdown-content bg-fuchsia-700 rounded-box z-[50] mt-3 w-52 p-2 shadow">
